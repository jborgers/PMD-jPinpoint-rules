...
public class RulesetMerger {
    ...
    public static void main(String[] args) {
        ...
        if (args.length >= 3) {
            ...
            String repositoryDirName = args[0];
            ...
            System.out.println(String.format("\t repository directory name:           %s", repositoryDirName));
            ...
            File githubProjectDir = new File(projectDir, repositoryDirName);
