...
To work around this, use a Reentrant lock with try-finally. However, we consider it risky and do *not* recommend to use virtual threads before JDK 24. Therefore, we also do not promote this workaround.
