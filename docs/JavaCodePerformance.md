...
**Example:**
```java
class WrongUseOfGuardedByExample {
  ...
  // no guarding: not synchronized, promise not met. A violation is reported by another rule when GuardedBy use is correct.
  public static String getText() {
    return txt;
  }
}

class RightUseOfGuardedByExample {
